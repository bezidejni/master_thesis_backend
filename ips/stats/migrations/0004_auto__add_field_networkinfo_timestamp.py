...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NetworkInfo.timestamp'
        db.add_column(u'stats_networkinfo', 'timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NetworkInfo.timestamp'
        db.delete_column(u'stats_networkinfo', 'timestamp')
